...
import { usarHabilidade, defender, esperar } from './batalhaEngine';
...
/**
 * Simula dano de uma habilidade (versão simplificada)
 */
function simularDano(habilidade, atacante, defensor) {
  ...
  // Vantagem elemental (importar função se necessário)
  // Por enquanto, fator neutro
